...
class ManualGenerationComplexTests(unittest.TestCase):
    ...
    def test_create_diagram_manually(self):
        ...
        [task1_id, _] = bpmn_graph.add_modify_task_to_diagram(process_id, task_name="First task")
        ...
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, parallel_gate_fork_id, task2_par_id)
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, task1_par_id, parallel_gate_join_id)
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, task2_par_id, parallel_gate_join_id)
        ...
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, exclusive_gate_fork_id, task2_ex_id)
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, task1_ex_id, exclusive_gate_join_id)
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, task2_ex_id, exclusive_gate_join_id)
        ...
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, inclusive_gate_fork_id, task2_in_id)
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, task1_in_id, inclusive_gate_join_id)
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, task2_in_id, inclusive_gate_join_id)

        [end_id, _] = bpmn_graph.add_modify_end_event_to_diagram(process_id, end_event_name="end_event")
        bpmn_graph.add_modify_sequence_flow_to_diagram(process_id, inclusive_gate_join_id, end_id)

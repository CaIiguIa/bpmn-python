...
class MetricsTests(unittest.TestCase):
    ...
    @staticmethod
    def load_example_diagram(filepath: str) -> BpmnDiagramGraph:
        bpmn_graph = diagram.BpmnDiagramGraph()
        bpmn_graph.load_diagram_from_xml_file(os.path.abspath(filepath))
        return bpmn_graph

    def test_count_crossing_points(self) -> None:
    ...
    def test_compute_longest_path_tasks(self) -> None:
        bpmn_graph = MetricsTests.load_example_diagram(self.cycles_example_path)
